...
function Card(props) {
  // const [cardLanguages, setLanguages] = useState("C#");
  // const [cardTitle, setTitle] = useState("Default");
  ...
  function handleCopy() {
    ...
    eventBus.dispatch("copyPopup", {});
  }
  function handleDelete() {
    axios
      .delete("http://localhost:5000/cards", {
        data: {
  ...
  return (
    ...
    >
      <div className="card-languages">{props.languages}</div>
